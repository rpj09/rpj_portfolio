                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 pointer-events-auto">
                        ...
                        <div className="md:col-span-5 md:col-start-8 flex flex-col justify-center gap-6">
                            {[
                                ...
                                >
                                    <h3 className="text-gray-300 font-heading font-bold text-2xl md:text-3xl mb-2 transition-transform duration-500 group-hover:translate-x-4 group-hover:text-white">
                                        <span className="text-white opacity-0 group-hover:opacity-100 transition-opacity absolute -left-5 top-1 text-base">▹</span>
                                        {item.title}
                                    </h3>
                                    <p className="text-gray-600 font-mono text-sm tracking-widest uppercase transition-transform duration-500 group-hover:translate-x-4">
                                        {item.desc}
                                    </p>
                                </div>
                            ))}
